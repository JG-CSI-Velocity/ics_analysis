...
from ics_analysis.formatting import excel_number_format, format_value
...
class TestFormatValue:
    ...
    def test_percentage_fraction(self):
        # Stored as 0-1, displayed as percentage
        assert format_value(0.75, "% of Total") == "75.0%"

    def test_percentage_pct_column(self):
        assert format_value(0.123, "Hit Pct") == "12.3%"

    def test_percentage_already_large(self):
        # Values > 2.0 are treated as already-percentage values
