...
def write_pptx_report(
    ...
    try:
        from ics_analysis.exports.deck_builder import DeckBuilder, SlideContent  # noqa: F401
...
def _render_chart_pngs(charts: dict, settings: Settings) -> dict[str, bytes]:
    ...
    pngs: dict[str, bytes] = {}
    try:
        from ics_analysis.charts import render_chart_png
...
def _build_with_deck_builder(
    ...
    from ics_analysis.exports.deck_builder import DeckBuilder, SlideContent
