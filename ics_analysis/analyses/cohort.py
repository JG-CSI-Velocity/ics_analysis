...
from ics_analysis.analyses.base import AnalysisResult, safe_percentage, safe_ratio
from ics_analysis.analyses.templates import (
    append_grand_total_row,
    kpi_summary,
)
from ics_analysis.settings import Settings
from ics_analysis.utils import add_l12m_activity, add_opening_month
...
def analyze_cohort_activation(
    ...
    for cohort in cohorts:
        ...
        avg_bal = round(cohort_data["Curr Bal"].mean(), 2) if size > 0 else 0.0
